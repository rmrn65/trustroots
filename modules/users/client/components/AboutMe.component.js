...
export class AboutMe extends Component {
  constructor(props) {
    super(props);
    this.changeProfileDescriptionToggle = this.changeProfileDescriptionToggle.bind(
      this,
    );
      ...
      <>
        <section className="panel panel-default">
          ...
          <div className="panel-body">
            {/* Short descriptions */}
            {(profile.description.length < 2400 ||
              this.state.profileDescriptionToggle) && (
              <div
                ...
                <div className="panel-more-wrap">
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: limitTo(profile.description, 2400),
                    }}
                  ></div>
                  <div
                    className="panel-more-fade"
                    onClick={this.changeProfileDescriptionToggle}
                  >
                    {t('Show more...')}
                  </div>
                </div>
          ...
          {isSelf &&
            (!profile.description ||
              plainTextLength(profile.description) <
                appSettings.profileMinimumLength) && (
